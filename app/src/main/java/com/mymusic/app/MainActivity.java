...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String Broadcast_PLAY_NEW_AUDIO = "com.mymusic.app.PlayNewAudio";
...
//                      //shouldShowRequestPermissionRationale will return true
    ...
    private void playAudio(int audioIndex) {
        ...
        loadCollapsingImage(audioList.get(audioIndex).getImage());
    }
    ...
    private void loadAudio() {
        ...
        try {
            audioList = new LoadAudioTask().execute("http://mymusic.api.konstantin-sidorenko.fr/musiques").get();
